...
@Table(name = "logs")
@NamedQueries({
   @NamedQuery(name = "Log2Entity.findAll", query = "SELECT l FROM Log2Entity l"),
   @NamedQuery(name = "Log2Entity.findNoProcess", query = "SELECT l FROM Log2Entity l WHERE l.procesados IS NULL ORDER BY l.seq ASC"), })
public class Log2Entity implements Serializable {
